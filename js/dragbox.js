...
jQuery( document ).ready( function($){
	var collapsed_widgets = bpmh_vars.collapsed;
	
	for( i in collapsed_widgets ) {
		if( collapsed_widgets[i].collapsed == "1" )
			$( '#'+ collapsed_widgets[i].widget_id +' .dragbox-content' ).css( 'display', 'none' );
	}
});